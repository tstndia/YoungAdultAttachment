...
audio_response = dict(
    config='configs/recognition/attachment/attachment_response_audio_small_cl256_fi16.py',
    checkpoint='work_dirs/attachment_response_audio_small_cl256_fi16_ep100/latest.pth'
)