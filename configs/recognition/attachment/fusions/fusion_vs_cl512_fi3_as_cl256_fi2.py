...
video_response = dict(
    config='configs/recognition/attachment/attachment_response_video_small_cl512_fi3.py',
    checkpoint='work_dirs/attachment_response_video_small_cl512_fi3_b8_ep30/latest.pth'
)
