...
class AttachmentClassifier(pl.LightningModule):
    def __init__(self, in_channels, num_classes=2):
        ...
        self.confusion_matrix = torchmetrics.ConfusionMatrix(task="binary", num_classes=num_classes)
        self.accuracy = BinaryAccuracy(num_classes=num_classes)
        self.prec = BinaryPrecision(num_classes=num_classes)
        self.f1_score = BinaryF1Score(num_classes=num_classes)
        self.recall = BinaryRecall(num_classes=num_classes)
